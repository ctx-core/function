 ...
 */
export declare function _one_andand_or</*@formatter:off*/ I extends unknown = unknown, O extends unknown = unknown>(/*@formatter:on*/ name_a1: andand_name_type<I, O>[], or_fn: andand_or_fn_type<I, O>): (obj: I) => I | O;
