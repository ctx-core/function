 ...
 */
export declare function andand_or</*@formatter:off*/ I extends unknown = unknown, O extends unknown = unknown>(/*@formatter:on*/ obj: I, name_a1: andand_name_type<I, O>[], or_fn: andand_or_fn_type<I, O>): I | O;
