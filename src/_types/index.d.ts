...
export declare type a_nowrap_T<I extends unknown = unknown> = I|I[]|I[][];
export declare type ANowrapT = a_nowrap_T;
export declare type bind_call_T<A extends unknown[] = unknown[], O extends unknown = unknown> = (...fn_arg_a: A) => O;
export declare type bind_call_type = bind_call_T;
export declare type call_fn_T<A extends unknown[] = unknown[], O extends unknown = unknown> = (...args: A) => O;
...
export declare type wrap_a_T<I extends unknown = unknown> = I extends unknown[] ? I : I[];
export declare type wrap_a1_T = wrap_a_T;
export declare type wrap_a1_type = wrap_a_T;
export declare type wrap_a_T2<I extends unknown = unknown> = I[]|I[][]|wrap_a_T<I>|wrap_aa_T<I>;
export declare type wrap_aa_T<I extends unknown = unknown> = (I extends unknown[][] ? I : I extends unknown[] ? I[] : I[][]);
export declare type wrap_aa_type = wrap_aa_T;
export declare type wrap_aa_item_T<I extends unknown = unknown> = wrap_aa_T<I> extends (infer O)[][] ? O : never;
