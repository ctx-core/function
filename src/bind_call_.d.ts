 ...
 */
export declare function bind_call_</*@formatter:off*/ A1 extends unknown[] = unknown[], A2 extends unknown[] = unknown[], O2 extends unknown = unknown, S2 extends unknown = unknown>(/*@formatter:on*/ fn: call_fn_T<A2, O2>, self: S2, ...in_arg_a: A2[]): bind_call_T<A2>;
