 ...
 */
export declare function slice_arg_a_<In extends unknown = unknown, Out extends unknown[] = unknown[]>(fn:slice_arg_a_fn_T<In, Out>, begin_idx?:number, end_idx?:number):slice_arg_a_T<In, Out>;
export declare type slice_arg_a_fn_T<In extends unknown = unknown, Out extends unknown[] = unknown[]> = (arg_a:a_nowrap_T<In>)=>Out;
export declare type slice_arg_a_T<In extends unknown = unknown, Out extends unknown[] = unknown[]> = (arg_a:a_nowrap_T<In>)=>Out;
export {
