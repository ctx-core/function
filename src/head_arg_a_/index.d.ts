 ...
 */
import type { slice_arg_a_fn_T, slice_arg_a_T } from '../slice_arg_a_'
export declare function head_arg_a_<I extends unknown = unknown>(fn:slice_arg_a_fn_T<I>, count?:number):slice_arg_a_T<I>;
